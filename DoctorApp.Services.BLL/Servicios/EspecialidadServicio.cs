...
namespace DoctorApp.Services.BLL.Servicios
{
    public class EspecialidadServicio : IEspecialidadServicio
    {
        ...
        public async Task<EspecialidadDto> Agregar(EspecialidadDto modeloDto)
        {
            try
            {
                ...
                if (especialidad.Id == 0) throw new TaskCanceledException("La especialidad no se pudo crear");
        ...
        public async Task Actualizar(EspecialidadDto modeloDto)
        {
            try
            {
                ...
                if (especialidadDb == null) throw new TaskCanceledException("La especialidad no existe");
